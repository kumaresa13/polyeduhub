...
<head>
    ...
    <meta name="author" content="PolyEduHub Team" />
        <title>Admin Password Recovery - PolyEduHub</title>
        <!-- Bootstrap CSS -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                ...
                                <?php if (isset($_SESSION['reset_success'])): ?>
                                    ...
                                    <?php if (isset($_SESSION['demo_reset_link'])): ?>
                                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                                            ...
                                            <a href="<?php echo $_SESSION['demo_reset_link']; ?>" class="alert-link">
                                                Reset Password Link
                                            </a>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg">
                                    <div class="card-header justify-content-center"><h3 class="font-weight-light my-4">Admin Password Recovery</h3></div>
                                    <div class="card-body">
                                        <div class="small mb-3 text-muted">Enter your admin email address and we will send you a link to reset your password.</div>
                                        <form id="adminPasswordResetForm" action="admin-password-reset.php" method="POST">
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="admin-register.php">Need an admin account? Sign up!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
