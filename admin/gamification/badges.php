                    ...
                    <tbody>
                        <?php foreach ($badges as $badge): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button 
                                        class="btn btn-sm btn-primary edit-badge" 
                                    ...
                                    <button 
                                        class="btn btn-sm btn-danger delete-badge" 
                                        data-bs-toggle="modal" 
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-4 text-center">
                            <div class="p-3 rounded-circle mb-2" style="background-color: #cd7f32; width: 50px; height: 50px; margin: 0 auto;"></div>
                            <h5 class="font-weight-bold">Bronze Level</h5>
                            <p>0-199 Points</p>
                        </div>
                        <div class="col-md-4 text-center">
                            <div class="p-3 rounded-circle mb-2" style="background-color: #c0c0c0; width: 50px; height: 50px; margin: 0 auto;"></div>
                            <h5 class="font-weight-bold">Silver Level</h5>
                            <p>200-499 Points</p>
                        </div>
                        <div class="col-md-4 text-center">
                            <div class="p-3 rounded-circle mb-2" style="background-color: #ffd700; width: 50px; height: 50px; margin: 0 auto;"></div>
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <ul>
                        <li><strong>Points Required:</strong> The minimum number of points a user needs to earn this badge.</li>
                        <li><strong>Badge Icons:</strong> Upload badge icons to the <code>/assets/img/badges/</code> directory.</li>
                        <li><strong>Automatic Assignment:</strong> Badges are automatically assigned to users when they reach the required points.</li>
                        <li><strong>Badge Display:</strong> Badges appear on the user's profile and in the leaderboard.</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <form action="" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="edit_badge_description" name="description" rows="3"></textarea>
                    </div>
                    <div class="mb-3">
