<div class="sidebar">
    ...
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'general.php' ? 'active' : '' ?>" 
               href="<?= isset($nested) ? '../settings/' : 'settings/' ?>general.php">
                <i class="fas fa-fw fa-cog"></i>
                <span>General Settings</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'email.php' ? 'active' : '' ?>" 
               href="<?= isset($nested) ? '../settings/' : 'settings/' ?>email.php">
                <i class="fas fa-fw fa-envelope"></i>
                <span>Email Templates</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'maintenance.php' ? 'active' : '' ?>" 
               href="<?= isset($nested) ? '../settings/' : 'settings/' ?>maintenance.php">
