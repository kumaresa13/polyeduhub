                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="update_status.php" method="POST">
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="resource_id" value="<?= $resource['id'] ?>">                                                                value="<?= $resource['id'] ?>">
                                                            <input type="hidden" name="action" value="approve">

                                                            <!-- Add a checkbox for notification -->
                                                            <div class="form-check mt-3">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="send_notification"
                                                                    id="sendNotification<?= $resource['id'] ?>" checked>
                                                                <label class="form-check-label"
                                                                    for="sendNotification<?= $resource['id'] ?>">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                ...
                                                                <button type="submit" class="btn btn-success" name="approve_resource">Approve</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
