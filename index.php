    ...
    <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="col-md-5">
                ...
                <p><i class="fas fa-map-marker-alt me-2"></i> Polytechnic Sultan Abdul Halim Muadzam Shah</p>
                <p><i class="fas fa-envelope me-2"></i> info@polyeduhub.edu.my</p>
                <p><i class="fas fa-phone me-2"></i> +60 11 6356 2185</p>
            </div>
        </div>
        ...
        <div class="text-center">
            <p class="mb-0">&copy; 2025 PolyEduHub. All rights reserved.</p>
        </div>
    </div>
</footer>
