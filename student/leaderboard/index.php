                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 col-md-4 mb-4 mb-xl-0">
                            <div class="text-center">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= number_format($user_stats['points']) ?></div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-4">
                            <div class="text-center">
                                <div class="text-xs font-weight-bold text-uppercase mb-1">Level <?= $user_stats['level'] ?></div>
                                <div class="progress progress-sm mx-auto mb-2" style="max-width: 300px;">
                                    <?php
                                ...
                                <div class="small text-muted"><?= number_format($current_progress) ?>/<?= number_format($points_needed) ?> points</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tr class="<?= $user['is_current_user'] ? 'table-primary' : '' ?>">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?= $user['profile_image'] ? htmlspecialchars($user['profile_image']) : '../../assets/img/ui/default-profile.png' ?>" alt="<?= htmlspecialchars($user['first_name']) ?>" class="rounded-circle me-3" width="40" height="40">
                                        <div>
