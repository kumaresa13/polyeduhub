<?php
// This is the corrected version of student/profile/index.php
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-center">
                    <img class="img-profile rounded-circle mb-3" src="<?= (isset($user['profile_image']) && $user['profile_image']) ? $user['profile_image'] : '../../assets/img/ui/default-profile.png' ?>" 
                         alt="Profile Image" style="width: 150px; height: 150px;">
                    <h4 class="font-weight-bold"><?= htmlspecialchars(($user['first_name'] ?? '') . ' ' . ($user['last_name'] ?? '')) ?></h4>
                    <p class="text-gray-600 mb-4">
                        <i class="fas fa-graduation-cap mr-2"></i> <?= htmlspecialchars(isset($user['department']) && $user['department'] ? $user['department'] : 'Department not specified') ?>
                    </p>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="badge bg-success p-2">
                            <i class="fas fa-star me-1"></i> <?= number_format(isset($user['points']) ? $user['points'] : 0) ?> Points
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-6 text-center mb-3">
                            <div class="badge-icon mb-2">
                                <img src="../../assets/img/badges/<?= htmlspecialchars($badge['icon'] ?? 'default.png') ?>" alt="<?= htmlspecialchars($badge['name'] ?? 'Badge') ?>" width="50" height="50">
                            </div>
                            <div class="badge-name small font-weight-bold"><?= htmlspecialchars($badge['name'] ?? 'Badge') ?></div>
                        </div>
                        <?php endforeach; ?>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= isset($resource['created_at']) ? date('M d, Y', strtotime($resource['created_at'])) : 'N/A' ?></td>
                                    <td>
                                        <a href="../resources/view.php?id=<?= $resource['id'] ?? 0 ?>" class="btn btn-sm btn-info">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="../resources/download.php?id=<?= $resource['id'] ?? 0 ?>" class="btn btn-sm btn-success">
                    ...
                    <div class="activity-timeline">
                        ...
                        <div class="activity-item d-flex mb-3">
                            ...
                            <div class="activity-content">
                                ...
                                <div class="text-gray-600 small"><?= htmlspecialchars($activity['details'] ?? '') ?></div>
                                <div class="text-gray-500 small"><?= isset($activity['created_at']) ? time_elapsed_string($activity['created_at']) : 'N/A' ?></div>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card rounded shadow-sm">
                                <div class="card-body text-center">
                                    ...
                                    <h2 class="display-4"><?= number_format(isset($user['points']) ? $user['points'] : 0) ?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
