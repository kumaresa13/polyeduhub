                ...
                <div class="card-body">
                    <form action="upload.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Helps others find your resource. Example: java, programming, loops</div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">
                                Allowed types: <?= implode(', ', ALLOWED_EXTENSIONS) ?> (Max size: <?= formatFileSize(UPLOAD_MAX_SIZE) ?>)
                            </div>
                        </div>
